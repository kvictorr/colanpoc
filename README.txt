...
3. Install dependent libraries using pip install -r requirements.txt
4. Start the application using ColanPOC command.
5. Use a web browser and connect to http://localhost:8501
